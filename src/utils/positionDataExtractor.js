import { calculateEntryPtCoins, calculateEntryPtUSDT } from "./positionCalculations";

export const extractPositionData = (chart5mRef, chart1hRef, chart1dRef, symbol, risk) => {
  const charts = [
